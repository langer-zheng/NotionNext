...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '电焊仙人', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '曾经是一名专业的电焊师傅，学习手艺数十年，如今爱上了互联网，从此无法自拔', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://me.zhengliang.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '电焊仙人, 博客, 学习笔记, 计算机, 设计学, 建筑学, 数码, 艺术学, 教程, 心得, 笔记', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'me@zhengliang.org', // 邮箱地址 例如mail@tangly1024.com
